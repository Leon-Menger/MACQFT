...
\begin{lem}
  ...
  \begin{equation}\mathcal{H}_n (f_\bullet): \mathcal{H}_n(C_{1\bullet}) \lra \mathcal{H}_N (C_{2\bullet})  \end{equation}
  for each $n \in \NN$, defined by
  \begin{equation}[\mathcal{Z}_n] \lra [f_n(\mathcal{Z}_n)] \end{equation}
\begin{proof}
  ...
  \begin{equation}\partial_{2n}(f_n(z_n)) = f_{n-1}(\partial_{1n}(z_n)) = 0 \end{equation}
  ...
  \begin{equation}x^1, x^2 \in \mathcal{Z}_n \quad \quad and \quad \quad x^1-x^2 = b  \in \mathcal{B}_n\end{equation}
...
\begin{equation}\mathcal{H}^n := \ker(\delta^n) / \im(\delta^{n-1}) \end{equation}
...
\begin{equation}D^{n+1} := (C_n)^* = \Hom(C_n, G) \end{equation}
...
\begin{equation}\delta^n := \partial_n^* : \Hom(C_{n-1}, G) \lra \Hom(C_n, G)\end{equation}
...
\begin{rem}
  ...
  \begin{equation}f^n \circ \delta_1^{n-1} = \delta_2^{n-1} \circ f^{n-1} \end{equation}
