...
%TODO first 30 minutes of lecture 15
...
\begin{definition}
  ...
  \begin{align*}
    ...
    g &\colon V(\gamma) \lra \ZZ_{\geq 0} \quad \quad \text{(the germ map)}
  \end{align*}
...
\begin{definition}
  ...
  \end{align*}
  $$  $$
  which assigns a number to our graph.
\end{definition}
...
\begin{enumerate}
  ...
  \item $$ W(P,I) = \sum_\gamma \frac{1}{|\Aut(\gamma)|} \hbar^{g(\gamma)} w_\gamma (P,I) $$
\end{enumerate}
\end{ex}
