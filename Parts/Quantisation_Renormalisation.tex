...
\begin{definition}
  Let $f \in \OO(U)$ be homogeneous of degree $k$. Then we can define an $S_k$-invariant linear map
  \begin{align}
...
\begin{definition}
  Let us denote by $\OO^+(U) \llbracket \hbar \rrbracket \subset \OO(U) \llbracket \hbar \rrbracket$ the subset of functionals at least cubic modulo $\hbar$. An element $I \in \OO(U) \llbracket \hbar \rrbracket$ can be decomposed as $I = \sum_{i,k} \hbar^i I_{i,k}$ where $I_{i,k}$ is homogeneous of degree $k$ in $U$. Now fix an ordering of the set of tails of $\gamma$
...
\begin{enumerate}
  ...
  \item $w_\gamma(P,I)$ is homogeneous of degree $n$ and has the property
...
\begin{definition}[Local action functional]
  A functional $I \in \OO(\Ci(M))$ that can be written as $I = \sum_k I_k$ where $I_k$ is homogeneous of degree $k$ in the variable $a \in \Ci(M)$, that is
...
\begin{theo}
  ...
  for any $i,k$ with $I_{i,k}^{CT}$ homogeneous of degree $k$ as a function of $a \in \Ci(M)$ and such that for all $L \in (0,\infty)$ the limit
